describe("AddingConsultant Page", () => {
    ...
    it("should display an error message with invalid credentials", () => {
      ...
      cy.get("Typography.variant-body2[color=error]").should("exist").contains("*Please enter a valid email.");
    });
    ...
    it("should display an error message for missing required fields", () => {
      ...
      cy.get("Typography.variant-body2[color=error]").should("exist").contains("*Please enter all the details.");
    });
    ...
    it("should display an error message for an invalid mobile number", () => {
      ...
      cy.get("Typography.variant-body2[color=error]").should("exist").contains("*Enter a valid mobile number.");
    });
  });